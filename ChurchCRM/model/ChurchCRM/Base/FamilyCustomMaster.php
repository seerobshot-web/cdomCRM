...
abstract class FamilyCustomMaster implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\ChurchCRM\\model\\ChurchCRM\\Map\\FamilyCustomMasterTableMap';
     ...
     */
    protected int|null $fam_custom_order = null;
     ...
     */
    protected string|null $fam_custom_field = null;
     ...
     * Note: this column has a database default value of: ''
     */
    protected string|null $fam_custom_name = null;

    /**
     * The value for the fam_custom_special field.
     */
    protected int|null $fam_custom_special = null;
     ...
     */
    protected int|null $fam_custom_fieldsec = null;
    ...
    /**
     * Initializes internal state of ChurchCRM\model\ChurchCRM\Base\FamilyCustomMaster object.
     *
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $rowIndex = $useNumericIndex ? $startcol + 0 : FamilyCustomMasterTableMap::translateFieldName('Order', TableMap::TYPE_PHPNAME, $indexType);
            $columnValue = $row[$rowIndex];
            $this->fam_custom_order = $columnValue !== null ? (int)$columnValue : null;

            $rowIndex = $useNumericIndex ? $startcol + 1 : FamilyCustomMasterTableMap::translateFieldName('Field', TableMap::TYPE_PHPNAME, $indexType);
            $columnValue = $row[$rowIndex];
            $this->fam_custom_field = $columnValue !== null ? (string)$columnValue : null;

            $rowIndex = $useNumericIndex ? $startcol + 2 : FamilyCustomMasterTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType);
            $columnValue = $row[$rowIndex];
            $this->fam_custom_name = $columnValue !== null ? (string)$columnValue : null;

            $rowIndex = $useNumericIndex ? $startcol + 3 : FamilyCustomMasterTableMap::translateFieldName('CustomSpecial', TableMap::TYPE_PHPNAME, $indexType);
            $columnValue = $row[$rowIndex];
            $this->fam_custom_special = $columnValue !== null ? (int)$columnValue : null;

            $rowIndex = $useNumericIndex ? $startcol + 4 : FamilyCustomMasterTableMap::translateFieldName('FieldSecurity', TableMap::TYPE_PHPNAME, $indexType);
            $columnValue = $row[$rowIndex];
            $this->fam_custom_fieldsec = $columnValue !== null ? (int)$columnValue : null;

            $rowIndex = $useNumericIndex ? $startcol + 5 : FamilyCustomMasterTableMap::translateFieldName('TypeId', TableMap::TYPE_PHPNAME, $indexType);
            $columnValue = $row[$rowIndex];
            ...
            throw new PropelException('Error populating \ChurchCRM\model\ChurchCRM\FamilyCustomMaster object', 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildFamilyCustomMasterQuery::create(null, $this->buildPkeyCriteria())->fetch($con);
    ...
    public function getByPosition(int $pos)
    {
        return match ($pos) {
            ...
            1 => $this->getField(),
            2 => $this->getName(),
            3 => $this->getCustomSpecial(),
            4 => $this->getFieldSecurity(),
            5 => $this->getTypeId(),
            default => null
        };
    }
    ...
    {
        $tableMap = FamilyCustomMasterTableMap::getTableMap();
        $criteria = new Criteria(FamilyCustomMasterTableMap::DATABASE_NAME);

        if ($this->isColumnModified(FamilyCustomMasterTableMap::COL_FAM_CUSTOM_ORDER)) {
            $criteria->setUpdateValue($tableMap->getColumn('fam_custom_Order'), $this->fam_custom_order);
        }
        if ($this->isColumnModified(FamilyCustomMasterTableMap::COL_FAM_CUSTOM_FIELD)) {
            $criteria->setUpdateValue($tableMap->getColumn('fam_custom_Field'), $this->fam_custom_field);
        }
        if ($this->isColumnModified(FamilyCustomMasterTableMap::COL_FAM_CUSTOM_NAME)) {
            $criteria->setUpdateValue($tableMap->getColumn('fam_custom_Name'), $this->fam_custom_name);
        }
        if ($this->isColumnModified(FamilyCustomMasterTableMap::COL_FAM_CUSTOM_SPECIAL)) {
            $criteria->setUpdateValue($tableMap->getColumn('fam_custom_Special'), $this->fam_custom_special);
        }
        if ($this->isColumnModified(FamilyCustomMasterTableMap::COL_FAM_CUSTOM_FIELDSEC)) {
            $criteria->setUpdateValue($tableMap->getColumn('fam_custom_FieldSec'), $this->fam_custom_fieldsec);
        }
        if ($this->isColumnModified(FamilyCustomMasterTableMap::COL_TYPE_ID)) {
    ...
    {
        $tableMap = FamilyCustomMasterTableMap::getTableMap();
        $query = ChildFamilyCustomMasterQuery::create();
        $fam_custom_FieldColumn = new LocalColumnExpression($query, $tableMap->getName(), $tableMap->getColumn('fam_custom_Field'));
        $query->addAnd($fam_custom_FieldColumn, $this->fam_custom_field);
     ...
     * objects.
     *
     * @param object $copyObj An object of \ChurchCRM\model\ChurchCRM\FamilyCustomMaster (or compatible) type.
