...
abstract class EventAudience implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\ChurchCRM\\model\\ChurchCRM\\Map\\EventAudienceTableMap';
    ...
    /**
     * Initializes internal state of ChurchCRM\model\ChurchCRM\Base\EventAudience object.
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $rowIndex = $useNumericIndex ? $startcol + 0 : EventAudienceTableMap::translateFieldName('EventId', TableMap::TYPE_PHPNAME, $indexType);
            $columnValue = $row[$rowIndex];
            $this->event_id = $columnValue !== null ? (int)$columnValue : null;

            $rowIndex = $useNumericIndex ? $startcol + 1 : EventAudienceTableMap::translateFieldName('GroupId', TableMap::TYPE_PHPNAME, $indexType);
            $columnValue = $row[$rowIndex];
            $this->group_id = $columnValue !== null ? (int)$columnValue : null;
            ...
            throw new PropelException('Error populating \ChurchCRM\model\ChurchCRM\EventAudience object', 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildEventAudienceQuery::create(null, $this->buildPkeyCriteria())->fetch($con);
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(EventAudienceTableMap::COL_GROUP_ID)) {
            $criteria->setUpdateValue($tableMap->getColumn('group_id'), $this->group_id);
        }
    ...
    {
        $tableMap = EventAudienceTableMap::getTableMap();
        $query = ChildEventAudienceQuery::create();
        ...
        $group_idColumn = new LocalColumnExpression($query, $tableMap->getName(), $tableMap->getColumn('group_id'));
        $query->addAnd($group_idColumn, $this->group_id);
    ...
    {
        $pkIsValid = $this->getEventId() !== null &&
    ...
    {
        return ($this->getEventId() === null) && ($this->getGroupId() === null);
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \ChurchCRM\model\ChurchCRM\EventAudience (or compatible) type.
    ...
    {
        if ($this->aGroup === null && ($this->group_id !== null && $this->group_id !== 0)) {
