 ...
 *
 * @method static orderByPersonId($order = \Propel\Runtime\ActiveQuery\Criteria::ASC) Order by the p2g2r_per_ID column
 * @method static orderByGroupId($order = \Propel\Runtime\ActiveQuery\Criteria::ASC) Order by the p2g2r_grp_ID column
 * @method static orderByRoleId($order = \Propel\Runtime\ActiveQuery\Criteria::ASC) Order by the p2g2r_rle_ID column
 *
 * @method static groupByPersonId() Group by the p2g2r_per_ID column
 * @method static groupByGroupId() Group by the p2g2r_grp_ID column
 * @method static groupByRoleId() Group by the p2g2r_rle_ID column
 *
 ...
 *
 * @method \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r|null findOne(\Propel\Runtime\Connection\ConnectionInterface|null $con = null) Return the first \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r matching the query
 * @method \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r findOneOrCreate(\Propel\Runtime\Connection\ConnectionInterface|null $con = null) Return the first \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r matching the query, or a new \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r object populated from the query conditions when no match is found
 *
 * @method \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r|null findOneByPersonId(int $p2g2r_per_ID) Return the first \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r filtered by the p2g2r_per_ID column
 * @method \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r|null findOneByGroupId(int $p2g2r_grp_ID) Return the first \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r filtered by the p2g2r_grp_ID column
 * @method \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r|null findOneByRoleId(int $p2g2r_rle_ID) Return the first \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r filtered by the p2g2r_rle_ID column
 *
 * @method \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r requirePk($key, \Propel\Runtime\Connection\ConnectionInterface|null $con = null) Return the \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r by primary key and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r requireOne(\Propel\Runtime\Connection\ConnectionInterface|null $con = null) Return the first \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r matching the query and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r requireOneByPersonId(int $p2g2r_per_ID) Return the first \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r filtered by the p2g2r_per_ID column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r requireOneByGroupId(int $p2g2r_grp_ID) Return the first \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r filtered by the p2g2r_grp_ID column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r requireOneByRoleId(int $p2g2r_rle_ID) Return the first \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r filtered by the p2g2r_rle_ID column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method \ChurchCRM\model\ChurchCRM\Base\Collection\Person2group2roleP2g2rCollection|array<\ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r>|\Propel\Runtime\Collection\Collection<\ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r> find(\Propel\Runtime\Connection\ConnectionInterface|null $con = null) Return \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r objects based on current ModelCriteria
 * @method \ChurchCRM\model\ChurchCRM\Base\Collection\Person2group2roleP2g2rCollection findObjects(\Propel\Runtime\Connection\ConnectionInterface|null $con = null) Get \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r objects in ObjectCollection
 *
 * @method array<\ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r>|\Propel\Runtime\Collection\Collection<\ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r> findByPersonId(int|array<int> $p2g2r_per_ID) Return \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r objects filtered by the p2g2r_per_ID column
 * @method array<\ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r>|\Propel\Runtime\Collection\Collection<\ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r> findByGroupId(int|array<int> $p2g2r_grp_ID) Return \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r objects filtered by the p2g2r_grp_ID column
 * @method array<\ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r>|\Propel\Runtime\Collection\Collection<\ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r> findByRoleId(int|array<int> $p2g2r_rle_ID) Return \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r objects filtered by the p2g2r_rle_ID column
 *
 * @method array<\ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r>|\Propel\Runtime\Util\PropelModelPager<mixed> paginate($page = 1, $maxPerPage = 10, \Propel\Runtime\Connection\ConnectionInterface|null $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 *
 ...
 */
abstract class Person2group2roleP2g2rQuery extends TypedModelCriteria
{
    /**
     * @var string
     */
    ...
    /**
     * Initializes internal state of Person2group2roleP2g2rQuery object.
     *
    ...
    public function __construct(
        ...
        string $modelName = '\\ChurchCRM\\model\\ChurchCRM\\Person2group2roleP2g2r',
    ...
    /**
     * Returns a new ChildPerson2group2roleP2g2rQuery object. XS
     *
     ...
     *
     * @return \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2rQuery<null>
     */
     ...
     *
     * @return \ChurchCRM\model\ChurchCRM\Base\Person2group2roleP2g2r|mixed|array the result, formatted by the current formatter
     */
    public function findPk($key, ?ConnectionInterface $con = null)
    {
        ...
        $obj = Person2group2roleP2g2rTableMap::getInstanceFromPool($poolKey);
        if ($obj !== null) {
            return $obj;
        }
     ...
     *
     * @return \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r|null A model object, or null if the key is not found
     */
    protected function findPkSimple($key, ConnectionInterface $con): ?ChildPerson2group2roleP2g2r
    {
        ...
        if ($row) {
            ...
            $obj->hydrate($row);
            $poolKey = serialize(array_map(fn ($k) => (string)$k, $key));
            Person2group2roleP2g2rTableMap::addInstanceToPool($obj, $poolKey);
        }
        $stmt->closeCursor();
     ...
     * @param \Propel\Runtime\Connection\ConnectionInterface $con A connection object
     *
     * @return \ChurchCRM\model\ChurchCRM\Base\Person2group2roleP2g2r|mixed|array|null the result, formatted by the current formatter
     */
     ...
     * @param \Propel\Runtime\Connection\ConnectionInterface|null $con an optional connection object
     *
     * @return \Propel\Runtime\Collection\Collection<\ChurchCRM\model\ChurchCRM\Base\Person2group2roleP2g2r>|mixed|array the list of results, formatted by the current formatter
     */
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $resolvedColumn = $this->resolveLocalColumnByName('p2g2r_per_ID');
        $this->addUsingOperator($resolvedColumn, $key[0], Criteria::EQUAL);
        $resolvedColumn = $this->resolveLocalColumnByName('p2g2r_grp_ID');
    ...
    public function filterByPrimaryKeys(array $keys)
    {
        ...
        $resolvedColumn0 = $this->resolveLocalColumnByName('p2g2r_per_ID');
        $resolvedColumn1 = $this->resolveLocalColumnByName('p2g2r_grp_ID');
    ...
    {
        $resolvedColumn = $this->resolveLocalColumnByName('p2g2r_rle_ID');
        if (is_array($roleId)) {
            $useMinMax = false;
            if (isset($roleId['min'])) {
                $this->addUsingOperator($resolvedColumn, $roleId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($roleId['max'])) {
                $this->addUsingOperator($resolvedColumn, $roleId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        $this->addUsingOperator($resolvedColumn, $roleId, $comparison);
    ...
    public function filterByPerson($person, ?string $comparison = null)
    {
        if ($person instanceof Person) {
            return $this
                ->addUsingOperator($this->resolveLocalColumnByName('p2g2r_per_ID'), $person->getId(), $comparison);
            ...
            $this
                ->addUsingOperator($this->resolveLocalColumnByName('p2g2r_per_ID'), $person->toKeyValue('PrimaryKey', 'Id'), $comparison);
    ...
    public function filterByGroup($group, ?string $comparison = null)
    {
        if ($group instanceof Group) {
            return $this
                ->addUsingOperator($this->resolveLocalColumnByName('p2g2r_grp_ID'), $group->getId(), $comparison);
            ...
            $this
                ->addUsingOperator($this->resolveLocalColumnByName('p2g2r_grp_ID'), $group->toKeyValue('PrimaryKey', 'Id'), $comparison);
     ...
     *
     * @param \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r|null $person2group2roleP2g2r Object to remove from the list of results
     *
     * @return $this
     */
    public function prune(?ChildPerson2group2roleP2g2r $person2group2roleP2g2r = null)
    {
        if ($person2group2roleP2g2r) {
            $pkFilter = $this->buildFilter($this->resolveLocalColumnByName('p2g2r_per_ID'), $person2group2roleP2g2r->getPersonId(), Criteria::NOT_EQUAL);
            $pkFilter->addOr($this->buildFilter($this->resolveLocalColumnByName('p2g2r_grp_ID'), $person2group2roleP2g2r->getGroupId(), Criteria::NOT_EQUAL));
