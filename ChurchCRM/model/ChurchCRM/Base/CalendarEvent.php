...
abstract class CalendarEvent implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\ChurchCRM\\model\\ChurchCRM\\Map\\CalendarEventTableMap';
    ...
    /**
     * Calendar associated via Calendar relation (n:1).
     */
    protected Calendar|null $aCalendar = null;
    ...
    /**
     * Initializes internal state of ChurchCRM\model\ChurchCRM\Base\CalendarEvent object.
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $rowIndex = $useNumericIndex ? $startcol + 0 : CalendarEventTableMap::translateFieldName('CalendarId', TableMap::TYPE_PHPNAME, $indexType);
            $columnValue = $row[$rowIndex];
            $this->calendar_id = $columnValue !== null ? (int)$columnValue : null;

            $rowIndex = $useNumericIndex ? $startcol + 1 : CalendarEventTableMap::translateFieldName('EventId', TableMap::TYPE_PHPNAME, $indexType);
            $columnValue = $row[$rowIndex];
            ...
            throw new PropelException('Error populating \ChurchCRM\model\ChurchCRM\CalendarEvent object', 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildCalendarEventQuery::create(null, $this->buildPkeyCriteria())->fetch($con);
    ...
    public function toArray(
        ...
        if ($includeForeignObjects) {
            if ($this->aCalendar !== null) {
                $key = match ($keyType) {
                     TableMap::TYPE_CAMELNAME => 'calendar',
                     TableMap::TYPE_FIELDNAME => 'calendars',
                     default => 'Calendar',
                };
    ...
    {
        $tableMap = CalendarEventTableMap::getTableMap();
        $query = ChildCalendarEventQuery::create();
    ...
    {
        $pkIsValid = $this->getCalendarId() !== null &&
                     $this->getEventId() !== null;
    ...
    {
        return ($this->getCalendarId() === null) && ($this->getEventId() === null);
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \ChurchCRM\model\ChurchCRM\CalendarEvent (or compatible) type.
    ...
    /**
     * Declares an association between this object and a Calendar object.
     *
     * @param \ChurchCRM\model\ChurchCRM\Base\Calendar|null $calendar
     *
     * @return $this
     */
    public function setCalendar(?Calendar $calendar = null)
    {
        ...
        $calendar?->addCalendarEvent($this);
     ...
     *
     * @return \ChurchCRM\model\ChurchCRM\Base\Calendar|null
     */
    public function getCalendar(?ConnectionInterface $con = null)
    {
        if ($this->aCalendar === null && ($this->calendar_id !== null && $this->calendar_id !== 0)) {
