...
abstract class PersonCustom implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\ChurchCRM\\model\\ChurchCRM\\Map\\PersonCustomTableMap';
    ...
    /**
     * Initializes internal state of ChurchCRM\model\ChurchCRM\Base\PersonCustom object.
     *
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $rowIndex = $useNumericIndex ? $startcol + 0 : PersonCustomTableMap::translateFieldName('PerId', TableMap::TYPE_PHPNAME, $indexType);
            ...
            throw new PropelException('Error populating \ChurchCRM\model\ChurchCRM\PersonCustom object', 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildPersonCustomQuery::create(null, $this->buildPkeyCriteria())->fetch($con);
    ...
    {
        $tableMap = PersonCustomTableMap::getTableMap();
    ...
    {
        $tableMap = PersonCustomTableMap::getTableMap();
        $query = ChildPersonCustomQuery::create();
     ...
     * objects.
     *
     * @param object $copyObj An object of \ChurchCRM\model\ChurchCRM\PersonCustom (or compatible) type.
    ...
    {
        if ($this->aPerson === null && ($this->per_id !== null && $this->per_id !== 0)) {
    ...
    {
        if ($this->aPerson !== null) {
            $this->aPerson->setPersonCustom(null);
        }
        $this->per_id = null;
        $this->alreadyInSave = false;
        $this->clearAllReferences();
