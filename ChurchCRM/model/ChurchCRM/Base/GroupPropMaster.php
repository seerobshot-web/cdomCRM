...
abstract class GroupPropMaster implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\ChurchCRM\\model\\ChurchCRM\\Map\\GroupPropMasterTableMap';
     ...
     * Note: this column has a database default value of: 0
     */
    protected int|null $prop_id = null;
     ...
     * Note: this column has a database default value of: '0'
     */
    protected string|null $prop_field = null;

    /**
     * The value for the prop_name field.
     */
    protected string|null $prop_name = null;

    /**
     * The value for the prop_description field.
     */
    protected string|null $prop_description = null;
     ...
     */
    protected int|null $prop_special = null;
     ...
     */
    protected string|null $prop_persondisplay = null;
    ...
    /**
     * Initializes internal state of ChurchCRM\model\ChurchCRM\Base\GroupPropMaster object.
     *
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $rowIndex = $useNumericIndex ? $startcol + 0 : GroupPropMasterTableMap::translateFieldName('GrpId', TableMap::TYPE_PHPNAME, $indexType);
            $columnValue = $row[$rowIndex];
            $this->grp_id = $columnValue !== null ? (int)$columnValue : null;

            $rowIndex = $useNumericIndex ? $startcol + 1 : GroupPropMasterTableMap::translateFieldName('PropId', TableMap::TYPE_PHPNAME, $indexType);
            $columnValue = $row[$rowIndex];
            $this->prop_id = $columnValue !== null ? (int)$columnValue : null;

            $rowIndex = $useNumericIndex ? $startcol + 2 : GroupPropMasterTableMap::translateFieldName('Field', TableMap::TYPE_PHPNAME, $indexType);
            $columnValue = $row[$rowIndex];
            $this->prop_field = $columnValue !== null ? (string)$columnValue : null;

            $rowIndex = $useNumericIndex ? $startcol + 3 : GroupPropMasterTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType);
            $columnValue = $row[$rowIndex];
            $this->prop_name = $columnValue !== null ? (string)$columnValue : null;

            $rowIndex = $useNumericIndex ? $startcol + 4 : GroupPropMasterTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType);
            $columnValue = $row[$rowIndex];
            $this->prop_description = $columnValue !== null ? (string)$columnValue : null;

            $rowIndex = $useNumericIndex ? $startcol + 5 : GroupPropMasterTableMap::translateFieldName('TypeId', TableMap::TYPE_PHPNAME, $indexType);
            $columnValue = $row[$rowIndex];
            $this->type_id = $columnValue !== null ? (int)$columnValue : null;

            $rowIndex = $useNumericIndex ? $startcol + 6 : GroupPropMasterTableMap::translateFieldName('Special', TableMap::TYPE_PHPNAME, $indexType);
            $columnValue = $row[$rowIndex];
            $this->prop_special = $columnValue !== null ? (int)$columnValue : null;

            $rowIndex = $useNumericIndex ? $startcol + 7 : GroupPropMasterTableMap::translateFieldName('PersonDisplay', TableMap::TYPE_PHPNAME, $indexType);
            $columnValue = $row[$rowIndex];
            $this->prop_persondisplay = $columnValue !== null ? (string)$columnValue : null;
            ...
            throw new PropelException('Error populating \ChurchCRM\model\ChurchCRM\GroupPropMaster object', 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildGroupPropMasterQuery::create(null, $this->buildPkeyCriteria())->fetch($con);
    ...
    public function getByPosition(int $pos)
    {
        return match ($pos) {
            ...
            2 => $this->getField(),
            3 => $this->getName(),
            4 => $this->getDescription(),
            5 => $this->getTypeId(),
            6 => $this->getSpecial(),
            7 => $this->getPersonDisplay(),
            default => null
        };
    }
    ...
    public function toArray(
        ...
        $result = [
            $keys[0] => $this->getGrpId(),
            $keys[1] => $this->getPropId(),
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setGrpId($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setPropId($arr[$keys[1]]);
        }
    ...
    {
        $tableMap = GroupPropMasterTableMap::getTableMap();
        ...
        if ($this->isColumnModified(GroupPropMasterTableMap::COL_PROP_ID)) {
            $criteria->setUpdateValue($tableMap->getColumn('prop_ID'), $this->prop_id);
        }
        if ($this->isColumnModified(GroupPropMasterTableMap::COL_PROP_FIELD)) {
            $criteria->setUpdateValue($tableMap->getColumn('prop_Field'), $this->prop_field);
        }
        if ($this->isColumnModified(GroupPropMasterTableMap::COL_PROP_NAME)) {
            $criteria->setUpdateValue($tableMap->getColumn('prop_Name'), $this->prop_name);
        }
        if ($this->isColumnModified(GroupPropMasterTableMap::COL_PROP_DESCRIPTION)) {
            $criteria->setUpdateValue($tableMap->getColumn('prop_Description'), $this->prop_description);
        }
        if ($this->isColumnModified(GroupPropMasterTableMap::COL_TYPE_ID)) {
            $criteria->setUpdateValue($tableMap->getColumn('type_ID'), $this->type_id);
        }
        if ($this->isColumnModified(GroupPropMasterTableMap::COL_PROP_SPECIAL)) {
            $criteria->setUpdateValue($tableMap->getColumn('prop_Special'), $this->prop_special);
        }
        if ($this->isColumnModified(GroupPropMasterTableMap::COL_PROP_PERSONDISPLAY)) {
            $criteria->setUpdateValue($tableMap->getColumn('prop_PersonDisplay'), $this->prop_persondisplay);
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of \ChurchCRM\model\ChurchCRM\GroupPropMaster (or compatible) type.
