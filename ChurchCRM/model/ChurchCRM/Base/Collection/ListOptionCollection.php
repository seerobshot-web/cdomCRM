...
/**
 * Custom collection for ListOption.
 *
 * @extends \Propel\Runtime\Collection\ObjectCollection<\ChurchCRM\model\ChurchCRM\Base\ListOption>
 */
class ListOptionCollection extends ObjectCollection
{
    /**
     * @param array $data
     */
    public function __construct(array $data = [])
    {
        ...
        $this->setModel('\ChurchCRM\model\ChurchCRM\ListOption');
