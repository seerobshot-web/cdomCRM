...
/**
 * Custom collection for WhyCame.
 *
 * @extends \Propel\Runtime\Collection\ObjectCollection<\ChurchCRM\model\ChurchCRM\Base\WhyCame>
 */
class WhyCameCollection extends ObjectCollection
{
    /**
     * @param array $data
     */
    public function __construct(array $data = [])
    {
        ...
        $this->setModel('\ChurchCRM\model\ChurchCRM\WhyCame');
