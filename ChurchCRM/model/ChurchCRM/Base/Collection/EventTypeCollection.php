...
/**
 * Custom collection for EventType.
 *
 * @extends \Propel\Runtime\Collection\ObjectCollection<\ChurchCRM\model\ChurchCRM\Base\EventType>
 */
class EventTypeCollection extends ObjectCollection
{
    /**
     * @param array $data
     */
    public function __construct(array $data = [])
    {
        ...
        $this->setModel('\ChurchCRM\model\ChurchCRM\EventType');
     ...
     */
    public function populateEventTypes(?Criteria $criteria = null, ?ConnectionInterface $con = null): EventCollection
    {
