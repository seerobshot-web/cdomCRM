...
/**
 * Custom collection for Calendar.
 *
 * @extends \Propel\Runtime\Collection\ObjectCollection<\ChurchCRM\model\ChurchCRM\Base\Calendar>
 */
class CalendarCollection extends ObjectCollection
{
    /**
     * @param array $data
     */
    public function __construct(array $data = [])
    {
        ...
        $this->setModel('\ChurchCRM\model\ChurchCRM\Calendar');
