...
/**
 * Custom collection for CalendarEvent.
 *
 * @extends \Propel\Runtime\Collection\ObjectCollection<\ChurchCRM\model\ChurchCRM\Base\CalendarEvent>
 */
class CalendarEventCollection extends ObjectCollection
{
    /**
     * @param array $data
     */
    public function __construct(array $data = [])
    {
        ...
        $this->setModel('\ChurchCRM\model\ChurchCRM\CalendarEvent');
     ...
     */
    public function populateCalendar(?Criteria $criteria = null, ?ConnectionInterface $con = null): CalendarCollection
    {
