...
abstract class FamilyCustom implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\ChurchCRM\\model\\ChurchCRM\\Map\\FamilyCustomTableMap';
    ...
    /**
     * Initializes internal state of ChurchCRM\model\ChurchCRM\Base\FamilyCustom object.
     *
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $rowIndex = $useNumericIndex ? $startcol + 0 : FamilyCustomTableMap::translateFieldName('FamId', TableMap::TYPE_PHPNAME, $indexType);
            ...
            throw new PropelException('Error populating \ChurchCRM\model\ChurchCRM\FamilyCustom object', 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildFamilyCustomQuery::create(null, $this->buildPkeyCriteria())->fetch($con);
    ...
    {
        $tableMap = FamilyCustomTableMap::getTableMap();
    ...
    {
        $tableMap = FamilyCustomTableMap::getTableMap();
        $query = ChildFamilyCustomQuery::create();
     ...
     * objects.
     *
     * @param object $copyObj An object of \ChurchCRM\model\ChurchCRM\FamilyCustom (or compatible) type.
    ...
    {
        if ($this->aFamily === null && ($this->fam_id !== null && $this->fam_id !== 0)) {
    ...
    {
        if ($this->aFamily !== null) {
            $this->aFamily->setFamilyCustom(null);
        }
        $this->fam_id = null;
        $this->alreadyInSave = false;
        $this->clearAllReferences();
