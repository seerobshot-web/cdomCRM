...
class DonationFundTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'ChurchCRM.model.ChurchCRM.Map.DonationFundTableMap';
     ...
     */
    public const TABLE_NAME = 'donationfund_fun';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'DonationFund';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\ChurchCRM\\model\\ChurchCRM\\DonationFund';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'ChurchCRM.model.ChurchCRM.DonationFund';
     ...
     */
    public const COL_FUN_ID = 'donationfund_fun.fun_ID';

    /**
     * the column name for the fun_Active field
     */
    public const COL_FUN_ACTIVE = 'donationfund_fun.fun_Active';

    /**
     * the column name for the fun_Name field
     */
    public const COL_FUN_NAME = 'donationfund_fun.fun_Name';

    /**
     * the column name for the fun_Description field
     */
    public const COL_FUN_DESCRIPTION = 'donationfund_fun.fun_Description';

    /**
     * the column name for the fun_Order field
     */
    public const COL_FUN_ORDER = 'donationfund_fun.fun_Order';
    ...
    /**
     * @var class-string<\ChurchCRM\model\ChurchCRM\Base\Collection\DonationFundCollection>
     */
    public const DEFAULT_OBJECT_COLLECTION = '\ChurchCRM\model\ChurchCRM\Base\Collection\DonationFundCollection';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'Active', 'Name', 'Description', 'Order', ],
        self::TYPE_CAMELNAME     => ['id', 'active', 'name', 'description', 'order', ],
        self::TYPE_COLNAME       => [DonationFundTableMap::COL_FUN_ID, DonationFundTableMap::COL_FUN_ACTIVE, DonationFundTableMap::COL_FUN_NAME, DonationFundTableMap::COL_FUN_DESCRIPTION, DonationFundTableMap::COL_FUN_ORDER, ],
        self::TYPE_FIELDNAME     => ['fun_ID', 'fun_Active', 'fun_Name', 'fun_Description', 'fun_Order', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'Active' => 1, 'Name' => 2, 'Description' => 3, 'Order' => 4, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'active' => 1, 'name' => 2, 'description' => 3, 'order' => 4, ],
        self::TYPE_COLNAME       => [DonationFundTableMap::COL_FUN_ID => 0, DonationFundTableMap::COL_FUN_ACTIVE => 1, DonationFundTableMap::COL_FUN_NAME => 2, DonationFundTableMap::COL_FUN_DESCRIPTION => 3, DonationFundTableMap::COL_FUN_ORDER => 4, ],
        self::TYPE_FIELDNAME     => ['fun_ID' => 0, 'fun_Active' => 1, 'fun_Name' => 2, 'fun_Description' => 3, 'fun_Order' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];
    ...
    public static function populateObject(array $row, int $offset = 0, string $indexType = TableMap::TYPE_NUM): array
    {
        ...
        if (($obj = DonationFundTableMap::getInstanceFromPool($key)) !== null) {
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        ...
        $tableAlias = $alias ?: 'donationfund_fun';
        $criteria->addSelectColumn(new LocalColumnExpression($criteria, $tableAlias, $tableMap->columns['FUN_ID']));
        $criteria->addSelectColumn(new LocalColumnExpression($criteria, $tableAlias, $tableMap->columns['FUN_ACTIVE']));
        $criteria->addSelectColumn(new LocalColumnExpression($criteria, $tableAlias, $tableMap->columns['FUN_NAME']));
        $criteria->addSelectColumn(new LocalColumnExpression($criteria, $tableAlias, $tableMap->columns['FUN_DESCRIPTION']));
        $criteria->addSelectColumn(new LocalColumnExpression($criteria, $tableAlias, $tableMap->columns['FUN_ORDER']));
    }
    ...
    /**
     * @deprecated Delete via model or DonationFundQuery.
     *
    ...
    {
        trigger_deprecation('Propel', '2.0', 'TableMap::doDelete() should not be used anymore, delete via model or DonationFundQuery');
        ...
        if ($values instanceof Criteria) {
            $criteria = $values;
        } elseif ($values instanceof DonationFund) { // it's a model object
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(DonationFundTableMap::DATABASE_NAME);
            $criteria->addAnd(DonationFundTableMap::COL_FUN_ID, (array)$values, Criteria::IN);
        }
     ...
     *
     * @param \Propel\Runtime\ActiveQuery\Criteria|\ChurchCRM\model\ChurchCRM\DonationFund $criteria
    ...
    public static function doInsert($criteria, ?ConnectionInterface $con = null)
    {
        ...
        if ($criteria->hasUpdateValue(DonationFundTableMap::COL_FUN_ID)) {
